...
import vn.com.ps10686.bookzone.Model.Employee;
...
//    }
    ...
    private void getEmployee(){
        ...
        api.getEmployee().enqueue(new Callback<List>() {
            @Override
            public void onResponse(Call<List> call, Response<List> response) {
               // List<> ds = response.body();
                System.out.println(" LOLOLOLO" + response.body());

//                for (int i = 0; i <ds.size(); i++){
//                    Employee employee = ds.get(i);
//                    employeeArrayList.add(employee);
//                }
//                System.out.println("list employee" + employeeArrayList);
            }
